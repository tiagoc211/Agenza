...
for each agent. Read the [0.2.0 scope and workspace safety rules](docs/scope-0.2.0.md) and the
[dynamic terminal and workspace model](docs/workspace-model-0.2.0.md), then see
