...
- Before changing code, read `README.md`, `todo.json`, `docs/architecture.md`, the current release scope in `docs/scope-0.2.0.md`, and the dynamic state contract in `docs/workspace-model-0.2.0.md`, as well as the closest applicable `AGENTS.md` file.
...
1. Read `AGENTS.md`, `README.md`, `todo.json`, `docs/architecture.md`, `docs/scope-0.2.0.md`, and `docs/workspace-model-0.2.0.md` completely.
